...
var wantReadOnlyToolNames = []string{
	...
	tools.ToolGetStressSummary,
	tools.ToolGetAllDayStress,
	tools.ToolGetWeeklyStress,
	tools.ToolGetBodyBattery,
	...
	tools.ToolGetRestingHeartRateDay,
